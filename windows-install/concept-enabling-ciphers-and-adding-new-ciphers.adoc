...
----
È possibile aggiungere ulteriori cifrari a questa configurazione in `standalone-full.xml` file. Questo file si trova in: `<installdir>/jboss/standalone/configuration/standalone-full.xml`.
